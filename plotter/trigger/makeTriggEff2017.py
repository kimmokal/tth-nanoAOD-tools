...
if __name__ == "__main__":
	...
	basecuts = 'passFilters && nLep == 1 && HT1 > 350 && '#ST1 > 150 &&'
	...
	if 'SingleEl' in fileName:
		...
		#if "Run2017B" in fileName : continue 
		#	testTrig = ['Ele15_IsoVVVL_PFHT450||MetOR']
		#else : 
		testTrig = ['Ele115_CaloIdVT_GsfTrkIdT||Ele15_IsoVVVL_PFHT450||MetOR']#Ele105_CaloIdVT_GsfTrkIdT,Ele50_CaloIdVT_GsfTrkIdT_PFJet165
		varList = ['HT']
	...
	#       cuts = basecuts + 'nMu == 1 && Lep_pt > 25'
		...
		#testTrig = ['MuHT350']
		testTrig = ['Mu50||Mu15_IsoVVVL_PFHT450||MetOR']#,'Mu50||MuHT350MET50']
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
