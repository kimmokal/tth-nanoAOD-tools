...
if __name__ == "__main__":
	...
	basecuts = 'passFilters && nLep == 1 && HT > 350 &&'# ST > 150 &&'
	...
	if 'SingleEl' in fileName:
		...
		if lumi == 0:
			...
			if 'golden205pb' in fileName:
				...
				lumi = 666
		#refTrig = 'HLT_Ele23_WPLoose_Gsf'
		refTrig ='HLT_Ele27_WPTight_Gsf'
		#testTrig = ['Ele15_IsoVVVL_PFHT350']#,'EleHT350MET50']
		if 'Run2016B' in fileName :
			testTrig = ['Ele50_CaloIdVT_GsfTrkIdT_PFJet165||Ele105_CaloIdVT_GsfTrkIdT||Ele115_CaloIdVT_GsfTrkIdT||Ele15_IsoVVVL_PFHT350||MetOR']
		else : 
			testTrig = ['Ele50_CaloIdVT_GsfTrkIdT_PFJet165||Ele105_CaloIdVT_GsfTrkIdT||Ele115_CaloIdVT_GsfTrkIdT||Ele15_IsoVVVL_PFHT350||Ele15_IsoVVVL_PFHT400||MetOR']
	...
	#       cuts = basecuts + 'nMu == 1 && Lep_pt > 25'
		...
		#testTrig = ['MuHT350']
		if 'Run2016B' in fileName :
			testTrig = ['Mu50||Mu15_IsoVVVL_PFHT350||MetOR']
		else :	testTrig = ['Mu50||Mu15_IsoVVVL_PFHT400||MetOR']#,'Mu50||MuHT350MET50']
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		'''if 'Run2016B' in fileName :
			testTrig = ['Mu50','Mu15_IsoVVVL_PFHT350','Mu50||Mu15_IsoVVVL_PFHT350']
		else : testTrig = ['PFJet450 && AK8PFJet450','Mu50||Mu15_IsoVVVL_PFHT400','PFJet450 && AK8PFJet450||Mu50||Mu15_IsoVVVL_PFHT400']#,'Mu50||MuHT350MET50']
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		if 'Run2016B' in fileName :		
			testTrig = ['Mu50||Mu15_IsoVVVL_PFHT350','PFJet450 && AK8PFJet450||Mu50||Mu15_IsoVVVL_PFHT350','PFJet450 && AK8PFJet450|||Mu50||Mu15_IsoVVVL_PFHT350||PFMET170_NoiseCleaned']#,'Mu50||MuHT350MET50']
		else : testTrig = ['Mu50||Mu15_IsoVVVL_PFHT400','PFJet450 && AK8PFJet450||Mu50||Mu15_IsoVVVL_PFHT400','PFJet450 && AK8PFJet450|||Mu50||Mu15_IsoVVVL_PFHT400||PFMET170_NoiseCleaned']#,'Mu50||MuHT350MET50']
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		...
		varList = ['LT'] #LTNoHF
		cuts = basecuts + 'nMu == 1 && Lep_pt > 25 && HT > 500'
		testTrig = ['MuOR||MetOR']#,'Mu50||MuHT350MET50']
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
	
		cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && HT > 500'
		testTrig = ['EleOR||MetOR']#,'Ele105||EleHT350MET50']
		...
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		testTrig = ['EleOR||MetOR']
		cuts = basecuts + 'nEl == 1 && Lep_pt > 5 && HT> 0 && LT > 250'
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		testTrig = ['MuOR||MetOR']
		cuts = basecuts + 'nMu == 1 && Lep_pt > 5 && HT > 0'
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
		testTrig = ['MuOR||MetOR']
		cuts = basecuts + 'nMu == 1 && Lep_pt > 5 && HT> 0 && LT > 250'
		makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)	
		...
		testTrig = ['Ele15_IsoVVVL_PFHT350_PFMET50','Ele105_CaloIdVT_GsfTrkIdT']
	...
	###################
		...
		testTrig = ['Ele105_CaloIdVT_GsfTrkIdT']
