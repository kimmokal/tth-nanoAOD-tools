...
def getXsec(sample):
    if sample.find(   "DYJetsToLL_M-50_HT-400to600"	                ) !=-1 : return 5.674;
    ...
    #elif sample.find( "QCD_HT500to700_ext"                          ) !=-1 : return 32060.0; ext have the same Xsec as original sample and it will be assigned without this line 
    ...
    elif sample.find( "TTJets_LO_HT600to800"	                    ) !=-1 : return 1.65;
    elif sample.find( "TTJets_LO_HT800to1200"	                    ) !=-1 : return 0.6736;
    elif sample.find( "TTJets_LO_HT1200to2500"                      ) !=-1 : return 0.1194;
    elif sample.find( "TTJets_LO_HT2500toInf"                       ) !=-1 : return 0.001445;
    ...
    elif sample.find( "TTWToLNu"                                    ) !=-1 : return 0.2001;
    #elif sample.find( "TTWToLNu_ext2"                               ) !=-1 : return 0.2001;
    elif sample.find( "TTWToQQ"                                     ) !=-1 : return 0.405;
    elif sample.find( "TTZToLLNuNu"		                            ) !=-1 : return 0.2529;
    ...
    elif sample.find( "T_tWch"	                                    ) !=-1 : return 38.09;
